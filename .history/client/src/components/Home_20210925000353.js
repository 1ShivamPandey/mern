...
<div className="story">
  ...
  <div className="storybox">
     <img className="storyimg" src={whitepot}  height="100px"/>
     </div>

    <div className="storybox">
    <img  className="storyimg" src={goldwhite} height="100px" />
    </div>

    <div className="storybox">
      <img  className="storyimg" src={mug}  height="100px"/>
    </div>

     <div className="storybox">
     <img  className="storyimg" src={plates}  height="100px"/>
     </div>
