    ...
    if (state) {
      ...
      return (
        <>
          ...
          <ul>
            <NavLink aria-current="page" to="/"> <img height="50" width="100" src={astralshops} alt="astralshops"/>{" "} </NavLink>
            <input  className="searchbox" type="text" id="placeholdercolor" placeholder="Search"/>
            ...
            <div className="floatright">
             ...
             <b>  <NavLink  aria-current="page" to="/">Home</NavLink></b>
              ...
              <li>
                <NavLink to="/Signup">
                  <img className="margin-left" height="35px" src={carticon} ></img></NavLink>
              </li>
              ...
              <li>
                <NavLink to="/About">
                  <img  className="margin-left"  height="35px"  src={profileicon} ></img> </NavLink>
              </li>

              <li>
                <NavLink to="/Login">
                  <div className="center-icons-alignment">
                  <img className="margin-left" height="35px" src={logout}></img>
                  </div>
                </NavLink>
              </li>
