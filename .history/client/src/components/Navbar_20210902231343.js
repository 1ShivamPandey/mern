    ...
    if (state) {
      ...
      return (
        ...
        <b>  <NavLink  aria-current="page" to="/">Home</NavLink></b>
            ...
            <li>
              <NavLink to="/"><img  className="margin-left" height="50px" src={carticon}></img></NavLink>
            </li>
            ...
            <li>
              <NavLink to="/Logout"><img  className="margin-left" height="50px" src={logout}></img></NavLink>
            </li>
