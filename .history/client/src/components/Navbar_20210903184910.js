        ...
        <>
          <ul>
            ...
            <div className="floatright">
              ...
              <li>
                <NavLink to="/logout"> <img className="margin-left" height="35px" src={logout}></img>  </NavLink>
              </li>                             
            </div>
          </ul>
        </>
...
<div className="header-left-side">
  <div>
<NavLink aria-current="page" to="/"> <img height="80px" width="150px" src={astralshops} alt="astralshops"/></NavLink>
</div>
</div>
...
<div className="header-right-side-padding">
 ...
 <NavLink onClick={myFunction()} to="/About"><img  className="margin-left"  height="35px"  src={profileicon} ></img> </NavLink>
 </div>
 ...
 <div className="header-right-side-padding">
 <NavLink to="/Login"><img className="margin-left" height="35px" src={logout}></img> </NavLink>
</div>
