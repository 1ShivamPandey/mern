...
<NavLink aria-current="page" to="/"> <img width="50px"  src={astralshops} alt="astralshops"/></NavLink>
</div>
...
<div className="header-right-side" id="myTopnav">
{/* 
<div className="header-right-side-padding">
  ...
  <div className="header-right-side-padding">
  <NavLink to="/Signup"><img className="icons" src={carticon} ></img></NavLink>
</div>
  ...
  <div className="header-right-side-padding">
 <NavLink to="/About"><img   className="icons"  src={profileicon} ></img> </NavLink>
 </div>
...
<div className="header-right-side-padding">
 <NavLink to="javascript:void(0)"  onClick="myFunction()"><img className="icons" src={logout}></img> </NavLink>
</div>
