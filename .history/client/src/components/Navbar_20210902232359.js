    ...
    if (state) {
      ...
      return (
        ...
        <b>  <NavLink  aria-current="page" to="/">Home</NavLink></b>
            ...
            <li>
              <NavLink to="/Signup"><img  className="margin-left" height="50px" src={carticon}></img></NavLink>
            </li>

            <li>
              <NavLink to="/Contact"><img  className="margin-left" height="50px" src={contact}></img></NavLink>
            </li>

            <li>
              <NavLink to="/About"><img  className="margin-left" height="50px" src={profileicon}></img></NavLink>
            </li>

            <li>
              <NavLink to="/Login"><img  className="margin-left" height="50px" src={logout}></img></NavLink>
            </li>
