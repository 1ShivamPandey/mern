    ...
    if (state) {
        ...
        <>
          <ul>
            ...
            <div className="floatright">
              ...
              <li>
              <NavLink to="/Signup"><img  className="margin-left" height="25px" src={carticon}></img></NavLink>
            </li>

            <li>
              <NavLink to="/Contact"><img  className="margin-left" height="25px" src={contact}></img></NavLink>
            </li>

            <li>
              <NavLink to="/About"><img  className="margin-left" height="25px" src={profileicon}></img></NavLink>
            </li>

            <li>
              <NavLink to="/Logout"><img  className="margin-left" height="25px" src={logout}></img></NavLink>
            </li>
      ...
      return (
        ...
        <b>  <NavLink  aria-current="page" to="/">Home</NavLink></b>
            ...
            <li>
              <NavLink to="/Login"><img  className="margin-left" height="25px" src={logout}></img></NavLink>
            </li>
